...
-- Checking the two tables to verify that everything is correct.
...
-- I could clean the table (drop all records where the continent is NULL, or create a temp table excluding to run my queries off 
